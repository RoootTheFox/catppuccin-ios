...
- (instancetype)init {
  ...
  [respringButton setTitleColor:[UIColor systemBlueColor]
  ...
  self.navigationItem.rightBarButtonItem =
      [[UIBarButtonItem alloc] initWithCustomView:respringButton];
...
- (void)respring:(UIButton *)sender {
  ...
  id restartAction = [SBSRelaunchAction actionWithReason:@"RestartRenderServer"
                                                 options:4
                                               targetURL:nil];
