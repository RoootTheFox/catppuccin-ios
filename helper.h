...
+ (NSArray *)flavors {
    ...
    if (_flavors == nil) {
        _flavors =
            [[NSArray alloc] initWithObjects:@"latte", @"frappe", @"macchiato", @"mocha", nil];
    }
...
+ (NSArray *)accents {
    ...
    if (_accents == nil) {
        _accents =
            [[NSArray alloc] initWithObjects:@"rosewater", @"flamingo", @"pink", @"mauve", @"red",
                                             @"maroon", @"peach", @"yellow", @"green", @"teal",
                                             @"sky", @"sapphire", @"blue", @"lavender", nil];
    }
